...
class MenuTVC: UITableViewController {
    ...
    let lowOptions = [MindfulAct(name: "Mindful Walking", prompt: "Go for a walk. Notice all the body movements, sounds, patterns, and thoughts involved while walking."), MindfulAct(name: "Soles of the Feet", prompt: "Place awareness in the soles of your feet. Become aware of the sensations on the bottoms of the feet, such as the pressure of the floor or ground beneath the feet, or the warmth or coolness of the feet. Do this whenever you begin to notice yourself becoming anxious or upset."), MindfulAct(name: "Release Anxiety", prompt: "Become aware of anxiety. Notice all the body sensations, emotions, and thoughts associated with anxiety. Notice when anxiety makes an appearance in your day. Pause briefly to assess whether anxiety is present within you. You may also notice what makes anxiety worse, and what relieves it."), MindfulAct(name: "Notice Dislike", prompt: "Become aware of negative feelings you may have towards someone or something. Try to think about what happened just before these negatives feelings occurred. What sense impressions occurred - sight, sound, touch, taste, smell, or thought?" )]
